...
exports.getProfile = async (req, res, next) => {
  try {
    ...
    // Find the user by ID and exclude the password field in the response for security
...
// Updates the user's birthday + awards points if it is their birthday
exports.updateBirthday = async (req, res, next) => {
  try {
    ...
    if (isBirthdayToday) {
      ...
      // Award points IF no recent birthday award
